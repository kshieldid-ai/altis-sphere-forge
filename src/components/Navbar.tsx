            ...
            if (item.external) {
              return (
                <a
                  ...
                  className="flex items-center gap-1.5 rounded-full px-4 py-2 text-sm text-muted-foreground transition-all duration-300 hover:bg-background/70 hover:text-foreground"
                >
                  {item.label}
